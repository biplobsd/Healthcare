 ...
 * @author alpha4d
 */
public class AdminPharPanelList extends javax.swing.JFrame {
 List<Pharmacist> phlist=new ArrayList<Pharmacist>();
    /**
     * Creates new form PharPanel
     */
    public AdminPharPanelList() {
        initComponents();
        FileRead fr=new FileRead();
        phlist=fr.fileReadPharmacist();
         tableData();
    }
  public void tableData(){
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(remove, javax.swing.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE))
        ...
        jLabel8.setText("Pharmacists List");
    ...
    private void jRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRemoveActionPerformed
        ...
        i= jlist.getSelectedRow();
        if (i == -1) {
            JOptionPane.showMessageDialog(null, "Select a Pharmacist",
            ...
            fr.fileRemovePharmacist(phlist);
    ...
    private void jUpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jUpdateButtonActionPerformed
        ...
        if (i == -1) {
            ...
            nw.tableint(i);
            AdminPharPanelUpdate adu=new AdminPharPanelUpdate();
            adu.setVisible(true);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminPharPanelList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminPharPanelList().setVisible(true);
            }
        });
    }
