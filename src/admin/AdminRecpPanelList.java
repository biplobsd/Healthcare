 ...
 * @author alpha4d
 */
public class AdminRecpPanelList extends javax.swing.JFrame {
 List<Receptionist> phlist=new ArrayList<Receptionist>();
    /**
     * Creates new form RecpPanel
     */
    public AdminRecpPanelList() {
        initComponents();
        tableData();
    }
public void tableData(){
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Receptionists List");
    ...
    private void jRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRemoveActionPerformed
        ...
        if (i == -1) {
            ...
            fr.fileRemoveReceptionist(phlist);
    ...
    private void jUpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jUpdateButtonActionPerformed
        ...
        if (i == -1) {
            ...
            nw.tableint(i);
            AdminRecpPanelUpdate adu=new AdminRecpPanelUpdate();
            adu.setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminRecpPanelList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminRecpPanelList().setVisible(true);
            }
        });
    }
