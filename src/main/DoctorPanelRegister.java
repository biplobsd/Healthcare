 ...
 * @author alpha4d
 */
public class DoctorPanelRegister extends javax.swing.JFrame {

    /**
     * Creates new form DoctorPanel
     */
    public DoctorPanelRegister() {
        initComponents();
    }
...
if (jUserName.getText().isEmpty()
      ...
      Doctor aDoctor=new Doctor(qualification, 
              specialization, joinDate, 
              leaveDate, name, age, 
              gender, address, maritial, 
              phone, blood, username, 
              password);
      ...
      clear();
      DoctorLoginFrame obj=new DoctorLoginFrame();
      obj.setVisible(true);
      this.dispose();
}
    ...
    private void addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addMouseClicked
        DoctorLoginFrame dlf=new DoctorLoginFrame();
        dlf.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorPanelRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorPanelRegister().setVisible(true);
            }
        });
    }
