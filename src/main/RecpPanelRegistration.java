...
import patient.PatientPanelAppointment;
 ...
 * @author alpha4d
 */
public class RecpPanelRegistration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Receptionist Registration");
    ...
    private void add4addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_add4addMouseClicked
        RecpLoginFrame pa = new RecpLoginFrame();
        pa.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecpPanelRegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecpPanelRegistration().setVisible(true);
            }
        });
    }
